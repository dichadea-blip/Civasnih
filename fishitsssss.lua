-- CIVASGE FISH IT - FINAL INTEGRATED VERSION
-- DEVELOPER BY LUJELEKSI
-- COMPLETE SYSTEM: AUTO QUEST + FISHING + TELEGRAM HOOK + DATABASE
-- VERSION: FINAL MERGED - ALL FEATURES INTEGRATED

print("Loading CIVASGEE FISH IT - FINAL INTEGRATED VERSION...")
...
local Window = Rayfield:CreateWindow({
    Name = "CIVASGEE FISH IT - FINAL INTEGRATED VERSION",
    LoadingTitle = "CIVASGEE FISH IT - FINAL INTEGRATED VERSION",
    LoadingSubtitle = "DEVELOPER BY CIVASGEE",
...
local function StartUltraInstantBite()
    ...
    task.spawn(function()
        while UltraBiteActive do
            ...
            pcall(function()
                Window:SetWindowName("CxG ULTRA | " .. currentRate .. " FISH/SEC")
            end)
...
local function StopUltraInstantBite()
    ...
    pcall(function()
        Window:SetWindowName("CIVASGEE ULTRA INSTANT BITE")
    end)
end
...
local RejoinSaveFile = "CIVASGEERejoinData_" .. LocalPlayer.UserId .. ".json"
...
task.spawn(function()
    while task.wait(1) do
        ...
        if allTasksCompleted and questProgress >= 100 then
            ...
            completionMessage = completionMessage .. "CIVASGEE SCRIPT FISH IT - MISSION ACCOMPLISHED!\n"
            completionMessage = completionMessage .. "DEVELOPER: CIVASGEE\n"
        ...
        if not currentTask then
            ...
            if currentTask then
                ...
                nextTaskMessage = nextTaskMessage .. "CIVASGEE SCRIPT FISH IT - NEXT TASK STARTED\n"
                nextTaskMessage = nextTaskMessage .. "DEVELOPER: CIVASGEE\n"
        ...
        if currentTask.percent >= 100 and not QuestState.Fishing then
            ...
            taskCompleteMessage = taskCompleteMessage .. "CIVASGEE SCRIPT FISH IT - TASK COMPLETED\n"
            taskCompleteMessage = taskCompleteMessage .. "DEVELOPER: LUJELEKSI\n"
...
local function CreateUI()
    ...
    Tab6:CreateParagraph({
        Title = "CIVASGEE FISH IT - FINAL INTEGRATED VERSION",
    ...
    Tab6:CreateButton({
        ...
        Callback = function()
            ...
            print("=======================================")
            print("  CIVASGEE FISH IT - FINAL INTEGRATED")
    ...
    task.wait(1)
    Rayfield:Notify({
        Title = "CIVASGEE FISH IT - FINAL INTEGRATED",
        Content = "All systems ready - Database + Quest + Hook loaded!",
        Duration = 5
    })
    
    print("=======================================")
    print("  CIVASGEE FISH IT - FINAL INTEGRATED LOADED")
    print("  Status: ALL FEATURES WORKING")
    print("  Developer: CIVASGEE")
...
-- MAIN EXECUTION
print("Initializing CIVASGEE FISH IT - FINAL INTEGRATED VERSION...")
...
if not success then
    ...
    print("CIVASGEE FISH IT - FINAL INTEGRATED VERSION LOADED SUCCESSFULLY")
    print("Complete System - All Features Working Perfectly")
    print("Developer by CIVASGEE")
    print("Ready to use!")
    print("")
    print("INTEGRATED SYSTEMS:")
