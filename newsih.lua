				...
				pcall(function()
					if Mobile then
						...
						if mobileButton then
							...
							if imageLabel then
								imageLabel.Image = Window.Minimized and "rbxassetid://26578092" or "rbxassetid://26578092"
							end
						end
					else
...
function Library:CreateMinimizer(Config)
	...
	local iconAsset = "rbxassetid://26578092"
...
Home:AddButton({
    ...
    Callback = function()
        print("[CxGHub] Version:", Fluent.Version or "Unknown")
    end
})
...
REFishingStopped.OnClientEvent:Connect(function()
    ...
    local embedData = {
        ["embeds"] = {{
            ...
            ["footer"] = { ["text"] = "Fish It Webhook by CxGHub Project" },
