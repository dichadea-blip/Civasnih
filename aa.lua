...
Components.Window = (function()
	...
	return function(Config)
		...
		Window.TabDisplay = New("TextLabel", {
			RichText = true,
			Text = "Welcome To CivasGee ISYLHub",
			TextTransparency = 0,
			FontFace = Font.new("rbxassetid://12187365364", Enum.FontWeight.SemiBold, Enum.FontStyle.Normal),
			TextSize = 28,
			TextXAlignment = "Left",
...
Home:AddParagraph({
    Title = "WELCOME TO CivasGee ISYLHub",
...
Home:AddButton({
    ...
    Callback = function()
        print("[CivasGee ISYLHub] Version:", Fluent.Version or "Unknown")
    end
})
...
REFishingStopped.OnClientEvent:Connect(function()
    ...
    local embedData = {
        ["embeds"] = {{
            ...
            ["footer"] = { ["text"] = "Fish It Webhook by CivasGee ISYLHub Project" },
